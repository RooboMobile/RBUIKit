//
//  RBUIModalPresentationViewController.h
//  Pods
//
...
@class RBUIModalPresentationViewController;
@class RBUIModalPresentationWindow;
...
@protocol RBUIModalPresentationContentViewControllerProtocol <NSObject>
...
@protocol RBUIModalPresentationViewControllerDelegate <NSObject>
 ...
 */
- (BOOL)shouldHideModalPresentationViewController:(RBUIModalPresentationViewController *)controller;

/**
 *  modalController 即将隐藏时的回调方法，在调用完这个方法后才开始做一些隐藏前的准备工作，例如恢复 window 的 dimmed 状态等。
 *  @param  controller  当前的modalController
 */
- (void)willHideModalPresentationViewController:(RBUIModalPresentationViewController *)controller;
 ...
 *  @param  controller  当前的modalController
 */
- (void)didHideModalPresentationViewController:(RBUIModalPresentationViewController *)controller;
 ...
 */
@interface RBUIModalPresentationViewController : UIViewController {
    UITapGestureRecognizer      *_dimmingViewTapGestureRecognizer;
    CGFloat                     _keyboardHeight;
}

@property(nonatomic, weak) IBOutlet id<RBUIModalPresentationViewControllerDelegate> delegate;
 ...
 */
@property(nonatomic, strong) IBOutlet UIViewController<RBUIModalPresentationContentViewControllerProtocol> *contentViewController;
...
@interface RBUIModalPresentationViewController (Manager)
...
@interface RBUIModalPresentationViewController (UIAppearance)
...
@interface RBUIModalPresentationWindow : UIWindow

@end


@interface UIViewController (RBUIModalPresentationViewController)

/**
 *  获取弹出当前vieController的QMUIModalPresentationViewController
 */
@property(nonatomic, weak, readonly) RBUIModalPresentationViewController *modalPresentedViewController;
@end
